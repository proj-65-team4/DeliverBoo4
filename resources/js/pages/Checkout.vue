            ...
            <div class="p-2 border mb-3 rounded">
                ...
                <div class="py-4 d-block">
                    ...
                    <div class="row py-2" v-for="item in cart" :key="item.id">
                        ...
                        <div
                            class="col text-center d-flex gap-3 justify-content-center align-items-center"
                        >
                            <button
    ...
    mounted() {
        ...
        braintree.dropin.create(
            ...
            function (err, instance) {
                ...
                var hiddenNonceInput =
                    document.querySelector("#my-nonce-input");
